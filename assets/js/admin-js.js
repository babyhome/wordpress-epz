jQuery('documrnt').load(function() {
	...
	// hide and show field depending on choosen option in meta box 
	// Audio metabox
	jQuery('input[name=epz_audio_host_type]').on('change', function() {
		var audio_host_type = jQuery('input[name=epz_host_type]:checked').val();
	...
	jQuery('input[name=epz_audio_host_type]').trigger('change');
	
	// Video
	jQuery('input[name=epz_video_host_type]').on('change', function() {
		var video_host_type = jQuery('input[name=epz_video_host_type]:checked').val();
	...
	jQuery('input[name=epz_video_host_type]').trigger('change');
